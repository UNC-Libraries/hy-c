...
RSpec.describe 'ingest_from_ftp/view_status', type: :view do
  context 'with proquest selected' do
    ...
    it 'renders list of proquest statuses' do
      ...
      assert_select 'tr:first>td>a', text: 'View error', count: 0
      ...
      assert_select 'tr:last>td>a', text: 'View error', count: 1
      assert_select '.modal-title', text: 'Error for etdadmin_upload_942402.zip', count: 1
      assert_select '.modal-header > .modal-title', text: 'Error for etdadmin_upload_942402.zip', count: 1
