...
# from https://raw.githubusercontent.com/samvera/hyrax/b034218b89dde7df534e32d1e5ade9161e129a1d/spec/factories/generic_works.rb
FactoryBot.define do
  factory :work, aliases: [:generic_work, :private_generic_work], class: 'General' do
    transient do
      user { create(:user) }
  ...
  factory :work_without_access, class: 'General' do
    title { ['Test title'] }
