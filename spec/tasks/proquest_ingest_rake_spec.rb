...
describe "rake proquest:ingest", type: :task do
  ...
  it "creates a new work" do
    ...
    if Date.today < Date.parse('2019-12-31')
    ...
    elsif Date.parse('2019-12-31') < Date.today < Date.parse('2021-12-31')
      expect(dissertation1.visibility).to eq 'restricted'
      expect(dissertation1.embargo_release_date).to eq Date.parse('2021-12-31').to_datetime
    else
      expect(dissertation1.visibility).to eq 'open'
      expect(dissertation1.embargo_release_date).to be_nil
    end
    ...
    elsif Date.parse('2019-12-31') < Date.today < Date.parse('2020-12-31')
      expect(dissertation2.visibility).to eq 'restricted'
      expect(dissertation2.embargo_release_date).to eq Date.parse('2020-12-31').to_datetime
    else
      expect(dissertation2.visibility).to eq 'open'
      expect(dissertation2.embargo_release_date).to be_nil
    end
    ...
    if Date.today < Date.parse('2019-12-31')
      ...
      expect(dissertation3.visibility).to eq 'open'
      expect(dissertation3.embargo_release_date).to be_nil
    end
    ...
    if Date.today < Date.parse('2019-12-31')
      ...
      expect(dissertation4.visibility).to eq 'restricted'
      expect(dissertation4.embargo_release_date).to eq Date.parse('2021-12-31').to_datetime
    else
      expect(dissertation4.visibility).to eq 'open'
      expect(dissertation4.embargo_release_date).to be_nil
    end
    ...
    if Date.today < Date.parse('2020-12-31')
      ...
      expect(dissertation6.visibility).to eq 'open'
      expect(dissertation6.embargo_release_date).to be_nil
    end
    ...
    if Date.today < Date.parse('2019-12-31')
      ...
      expect(dissertation7.visibility).to eq 'open'
      expect(dissertation7.embargo_release_date).to be_nil
    end
  end
end
