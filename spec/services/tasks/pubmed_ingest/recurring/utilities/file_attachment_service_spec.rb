...
RSpec.describe Tasks::PubmedIngest::Recurring::Utilities::FileAttachmentService do
  ...
  describe 'module composition' do
    it 'includes the shared PMC S3 version lookup helper' do
      expect(described_class.included_modules).to include(Tasks::PubmedIngest::SharedUtilities::PmcS3VersionLookup)
    end
  end
end
