...
RSpec.describe Tasks::NoaaIngest::Backlog::Utilities::NoaaIngestTracker do
  let(:config) do
    {
  ...
  describe '#initialize_new!' do
    ...
    it 'calls super and adds expected Noaa-specific progress keys' do
    ...
    it 'adds input_csv_path to tracker data' do
      ...
      expect(data['input_csv_path']).to eq('/tmp/noaa_data.csv')
    end
  end
end
