  ...
  describe ".send_notification" do
    it 'sends a message to all users' do
      ...
      expect(approver).to receive(:send_message)
        .with(anything, I18n.t('hyrax.notifications.workflow.deletion_approved.message',
      ...
      expect {
        described_class.send_notification(entity: entity, user: approver, comment: comment,
