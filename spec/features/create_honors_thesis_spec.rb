...
RSpec.feature 'Create a HonorsThesis', js: false do
  context 'a logged in user' do
    ...
    scenario 'as a non-admin' do
      ...
      expect(page).to_not have_field('honors_thesis_language_label')
      expect(page).to_not have_field('honors_thesis_license_label')
      expect(page).to_not have_field('honors_thesis_rights_statement_label')
