...
RSpec.feature 'Create a DataSet', js: false do
  context 'a logged in user' do
    ...
    scenario 'as a non-admin' do
      ...
      expect(page).to_not have_field('data_set_language_label')
      expect(page).to_not have_field('data_set_license_label')
      expect(page).to_not have_field('data_set_rights_statement_label')
