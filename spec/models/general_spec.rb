...
RSpec.describe General do
  ...
  describe "metadata" do
    it "has descriptive metadata" do
      ...
      expect(subject).to respond_to(:advisor_display)
      ...
      expect(subject).to respond_to(:arranger_display)
      expect(subject).to respond_to(:award)
      expect(subject).to respond_to(:composers)
      expect(subject).to respond_to(:composer_display)
      ...
      expect(subject).to respond_to(:project_director_display)
      expect(subject).to respond_to(:publisher_version)
      expect(subject).to respond_to(:researchers)
      expect(subject).to respond_to(:researcher_display)
      expect(subject).to respond_to(:reviewers)
      expect(subject).to respond_to(:reviewer_display)
      ...
      expect(subject).to respond_to(:translator_display)
