...
RSpec.describe AssignPermissionsToWorkJob, type: :job do
  ...
  let(:reviewer1) {
    User.create(email: 'reviewer1@example.com', uid: 'reviewer1',
                password: 'password', password_confirmation: 'password')
  }
  let(:reviewer2) {
    User.create(email: 'reviewer2@example.com', uid: 'reviewer2',
                password: 'password', password_confirmation: 'password')
  }
  ...
  let(:workflow) {
    Sipity::Workflow.create(name: 'a workflow', permission_template_id: permission_template.id,
                            active: true)
  }
  let(:work) {
