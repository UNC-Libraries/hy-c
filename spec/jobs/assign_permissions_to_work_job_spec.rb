...
RSpec.describe AssignPermissionsToWorkJob, type: :job do
  ...
  let(:work) { HonorsThesis.create(title: ['a title'], depositor: 'admin@example.com', academic_department: ['biology'], admin_set_id: admin_set.id, visibility: Hydra::AccessControls::AccessRight::VISIBILITY_TEXT_VALUE_PRIVATE) }
