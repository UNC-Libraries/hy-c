...
RSpec.describe Hyrax::OpenAccessForm do
  let(:work) { OpenAccess.new }
  ...
  describe "#secondary_terms" do
    ...
    it { is_expected.to eq [:description, :license, :subject, :academic_department, :orcid, :author_status, :coauthor,
                            :publication, :issue, :publication_date, :publication_version, :link_to_publisher_version,
                            :granting_agency, :additional_funding] }
  end
