...
RSpec.describe Hyrax::DataSetForm do
  ...
  describe "#required_fields" do
    ...
    it {
      is_expected.to match_array [:title, :creator, :date_issued, :abstract, :methodology,
                                  :kind_of_data, :resource_type]
    }
  end
        ...
        expect(subject['creators_attributes'].as_json)
          .to include({ '0' => { 'name' => 'creator',
                        ...
                        '2' => { 'name' => 'creator3',
                                 ...
                                 'other_affiliation' => 'another affiliation',
                                 'index' => 3 } })
        expect(subject['contributors_attributes'].as_json)
          .to include({ '0' => { 'name' => 'contributor',
                                 'orcid' => 'contributor orcid',
                                 'affiliation' => 'Carolina Center for Genome Sciences',
                                 'other_affiliation' => 'another affiliation',
                                 'index' => 1 },
