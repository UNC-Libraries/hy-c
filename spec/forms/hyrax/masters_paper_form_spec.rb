...
RSpec.describe Hyrax::MastersPaperForm do
  ...
  describe "#secondary_terms" do
    ...
    it { is_expected.to match_array [:academic_concentration, :access, :dcmi_type, :degree_granting_institution, :doi,
                                     :extent, :geographic_subject, :note, :reviewer, :use, :keyword, :subject, :language,
  ...
  describe "#admin_only_terms" do
    ...
    it { is_expected.to match_array [:dcmi_type, :access, :doi, :degree_granting_institution, :extent, :use] }
  end
