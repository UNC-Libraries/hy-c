...
RSpec.describe Hyrax::DissertationPresenter do
  ...
  # As of hyrax 5, all missing methods delegate to solr_doc, so we don't need to delegate each field.
  # Instead we will verify that all the fields return the expected values from the attributes hash
  ...
  describe '#model_name' do
    ...
    it { expect(subject.human).to eq 'Dissertation' }
  end
