...
RSpec.describe Hyrax::HonorsThesisPresenter do
  ...
  let(:attributes) do
    { 'id' => '888888',
      'title_tesim' => ['foo'],
      'human_readable_type_tesim' => ['Undergraduate Honors Thesis'],
  ...
  describe '#model_name' do
    ...
    it { expect(subject.human).to eq 'Honors thesis' }
  end
  ...
  describe '#attribute_to_html' do
    ...
    context 'with a custom access_right field' do
      before do
        allow(Hyrax::Renderers::AttributeRenderer).to receive(:new).with(:access_right, ['an access right'], {}).and_return(renderer)
      end
