...
module Hyrax
  class DissertationForm < ::SingleValueForm
    ...
    self.terms += [:abstract, :academic_concentration, :access, :advisor, :affiliation, :alternative_title, :date_issued, :degree,
                   :degree_granting_institution, :discipline, :doi, :dcmi_type, :geographic_subject, :graduation_year,
