...
module Hyrax
  class ArticleForm < ::SingleValueForm
    ...
    self.terms += [:resource_type, :abstract, :access, :affiliation, :bibliographic_citation, :copyright_date,
                   :date_captured, :date_issued, :date_other, :dcmi_type, :doi, :edition, :extent, :funder,
