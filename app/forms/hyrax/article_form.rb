...
module Hyrax
  class ArticleForm < ::SingleValueForm
    ...
    self.admin_only_terms = [:dcmi_type, :date_created, :access, :bibliographic_citation, :copyright_date, :date_other, :doi,
                             :extent, :identifier, :rights_holder, :translator, :use]
