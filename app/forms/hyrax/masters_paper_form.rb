...
module Hyrax
  class MastersPaperForm < ::SingleValueForm
    ...
    self.terms += [:abstract, :academic_concentration, :access, :advisor, :affiliation, :date_issued, :degree,
                   :degree_granting_institution, :doi, :extent, :dcmi_type, :geographic_subject, :graduation_year, :medium, :note,
