...
module Hyrax
  class ArticlePresenter < Hyrax::WorkShowPresenter
    delegate :abstract, :access, :affiliation, :affiliation_label, :bibliographic_citation, :copyright_date,
             :date_captured, :date_issued, :date_other, :dcmi_type, :deposit_record, :doi, :edition, :extent, :funder,
             ...
             :place_of_publication, :rights_holder, :rights_statement_label, :table_of_contents, :translator, :url,
