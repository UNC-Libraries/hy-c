...
module Hyrax
  class GeneralPresenter < Hyrax::WorkShowPresenter
    delegate [:abstract, :academic_concentration, :access, :advisor, :affiliation, :alternate_title, :award,
              :bibliographic_citation, :conference_name, :copyright_date, :date_captured, :date_issued, :date_other,
