...
export class RequiredFields {
    ...
    updateSubmitButton() {
        let submitBtn = this.form.find('#with_files_submit');
    ...
    reload() {
        ...
        this.textFields.off('input change').on('input change', wrappedCallback);

        // Block submit if any text field exceeds the limit
        ...
        // Initial check for over-limit fields
