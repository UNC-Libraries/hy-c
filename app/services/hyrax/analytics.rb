...
module Hyrax
  module Analytics
    ...
    class Config
      # [hyc-override] Load the analytics yaml file as ERB first so it can pick up the ENV variables
      def self.load_from_yaml
        yaml = YAML.safe_load(ERB.new(File.read('config/analytics.yml')).result)
        unless yaml
