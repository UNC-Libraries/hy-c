...
class Tasks::PubmedIngest::Recurring::PubmedIngestCoordinatorService
  ...
  def format_results_and_notify
    raw_results = load_results(attachment_results_path: @file_attachment_results_path)
    @results     = format_results_for_reporting(raw_results_array: raw_results, tracker: @tracker)
    send_report_and_notify(attachment_results: @results, tracker: @tracker, csv_output_dir: @result_output_directory)
