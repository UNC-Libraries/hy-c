...
# Fetches and resolves DOI metadata from OpenAlex, Crossref, and DataCite.
module Tasks::IngestHelperUtils
  class DoiMetadataResolver
    ...
    def construct_attribute_builder
      ...
      when 'openalex'
        Tasks::IngestHelperUtils::SharedAttributeBuilders::OpenalexAttributeBuilder.new(
          @resolved_md,
          admin_set,
          depositor_onyen
        )
      when 'crossref'
        Tasks::IngestHelperUtils::SharedAttributeBuilders::CrossrefAttributeBuilder.new(
          @resolved_md,
          admin_set,
          depositor_onyen
        )
