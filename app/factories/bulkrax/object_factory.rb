# [hyc-override] updating `transform_attributes` and `permitted_attributes` methods
...
module Bulkrax
  class ObjectFactory
    ...
    def permitted_attributes
      ...
      properties + people.map{|p| "#{p}_attributes".to_sym} + %i[id edit_users edit_groups read_groups visibility work_members_attributes]
    end
  end
end
