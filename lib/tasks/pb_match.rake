...
task :attach_pubmed_pdfs_old, [:fetch_identifiers_output_csv, :file_retrieval_directory, :output_dir, :admin_set_title] => :environment do |task, args|
...
desc 'Ingest PubMed PDFs into Hyrax'
task :ingest_pubmed_pdfs, [:fetch_identifiers_output_csv, :file_retrieval_directory, :output_dir, :admin_set_title] => :environment do |task, args|
  return unless valid_args('attach_pubmed_pdfs', args[:fetch_identifiers_output_csv], args[:file_retrieval_directory], args[:output_dir], args[:admin_set_title])
