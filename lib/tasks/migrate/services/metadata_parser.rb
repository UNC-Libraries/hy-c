    ...
    class MetadataParser
      ...
      def parse
        ...
        if !descriptive_mods
          ...
          work_attributes['creator_display'] = build_person_display(work_attributes['creators_attributes']) if !work_attributes['creators_attributes'].blank?
          ...
          work_attributes['contributor_display'] = build_person_display(work_attributes['contributors_attributes']) if !work_attributes['contributors_attributes'].blank?
          work_attributes['advisors_attributes'] = parse_people_from_mods(descriptive_mods, 'Thesis advisor')
          work_attributes['advisor_display'] = build_person_display(work_attributes['advisors_attributes']) if !work_attributes['advisors_attributes'].blank?
          ...
          work_attributes['project_director_display'] = build_person_display(work_attributes['project_directors_attributes']) if !work_attributes['project_directors_attributes'].blank?
          work_attributes['researchers_attributes'] = parse_people_from_mods(descriptive_mods, 'Researcher')
          work_attributes['researcher_display'] = build_person_display(work_attributes['researchers_attributes']) if !work_attributes['researchers_attributes'].blank?
          ...
          work_attributes['translator_display'] = build_person_display(work_attributes['translators_attributes']) if !work_attributes['translators_attributes'].blank?
          work_attributes['reviewers_attributes'] = parse_people_from_mods(descriptive_mods, 'Reviewer')
          work_attributes['reviewer_display'] = build_person_display(work_attributes['reviewers_attributes']) if !work_attributes['reviewers_attributes'].blank?
          work_attributes['composers_attributes'] = parse_people_from_mods(descriptive_mods, 'Composer')
          work_attributes['composer_display'] = build_person_display(work_attributes['composers_attributes']) if !work_attributes['composers_attributes'].blank?
          work_attributes['arrangers_attributes'] = parse_people_from_mods(descriptive_mods, 'Arranger')
          work_attributes['arranger_display'] = build_person_display(work_attributes['arrangers_attributes']) if !work_attributes['arrangers_attributes'].blank?
