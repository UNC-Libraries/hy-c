    ...
    class MetadataParser
      ...
      def parse
        ...
        if !descriptive_mods
          ...
          @work_attributes['creator_label'] = []
          get_person_info(descriptive_mods, 'creator')
          get_person_info(descriptive_mods, 'contributor')
          @work_attributes['advisor_label'] = []
          get_person_info(descriptive_mods, 'advisor')
          get_person_info(descriptive_mods, 'arranger')
          get_person_info(descriptive_mods, 'composer')
          get_person_info(descriptive_mods, 'funder')
          get_person_info(descriptive_mods, 'project_director')
          get_person_info(descriptive_mods, 'researcher')
          get_person_info(descriptive_mods, 'reviewer')
          get_person_info(descriptive_mods, 'translator')
      ...
      private
        ...
        def parse_people_from_mods(mods, type)
          ...
          people.each_with_index do |person, index|
            ...
            if type == 'Creator'
              @work_attributes['creator_label'].push(name)
            elsif type == 'Thesis advisor'
              @work_attributes['advisor_label'].push(name)
            end
